            ...
            <TabsContent value="rewards" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="baseReward">Base Daily Reward</Label>
                      <div className="flex items-center gap-2">
                        <Coins className="h-4 w-4 text-yellow-500" />
                        <Input
                          id="baseReward"
                          type="number"
                          value={rewardSettings.baseReward}
                          onChange={(e) =>
                            setRewardSettings({
                              ...rewardSettings,
                              baseReward: Number.parseInt(e.target.value) || 0,
                            })
                          }
                          className="flex-1"
                        />
                      ...
                      <p className="text-xs text-gray-500">
                        Coins awarded for daily check-in ($
                        {(rewardSettings.baseReward * coinSettings.coinToUsdRate).toFixed(4)})
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        type="number"
                        step="0.1"
                        value={rewardSettings.streakMultiplier}
                        onChange={(e) =>
                          setRewardSettings({
                            ...rewardSettings,
                            streakMultiplier: Number.parseFloat(e.target.value) || 1,
                          })
                        }
                      />
                      <p className="text-xs text-gray-500">Multiplier applied for consecutive days</p>
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="maxBonus">Max Streak Bonus</Label>
                      <div className="flex items-center gap-2">
                        <Zap className="h-4 w-4 text-orange-500" />
                        <Input
                          id="maxBonus"
                          type="number"
                          value={rewardSettings.maxStreakBonus}
                          onChange={(e) =>
                            setRewardSettings({
                              ...rewardSettings,
                              maxStreakBonus: Number.parseInt(e.target.value) || 0,
                            })
                          }
                          className="flex-1"
                        />
                      </div>
                      <p className="text-xs text-gray-500">Maximum bonus coins from streak</p>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-7 gap-2">
                      {[1, 2, 3, 4, 5, 6, 7].map((day) => {
                        const baseReward = rewardSettings.baseReward
                        const streakBonus = Math.min(
                          Math.floor(baseReward * (rewardSettings.streakMultiplier - 1) * day),
                          rewardSettings.maxStreakBonus,
                        )
                        ...
                        return (
                          <Card key={day} className="text-center p-3">
                            ...
                            {streakBonus > 0 && <div className="text-xs text-orange-600">+{streakBonus} bonus</div>}
                          </Card>
                        )
                      })}
                    </div>
