              ...
              <CardContent className="p-6 space-y-6">
                {serviceTiers.length > 1 ? (
                        ...
                        <TabsContent key={tier.name} value={tier.name.toLowerCase()} className="mt-6">
                          <div className="border-2 border-primary/20 rounded-xl p-6 space-y-6 bg-gradient-to-br from-primary/5 to-secondary/5">
                            <div className="text-center">
                              ...
                              {tier.description && <p className="text-gray-600 leading-relaxed">{tier.description}</p>}
                            </div>
                  ...
                  <div className="text-center space-y-6 bg-gradient-to-br from-primary/5 to-secondary/5 p-6 rounded-xl">
                    <div className="text-4xl font-bold text-primary mb-3">${selectedTier?.price || service.price}</div>
                    <div className="grid grid-cols-2 gap-6 text-sm">
                      <div className="flex flex-col items-center space-y-2 bg-white/50 p-4 rounded-lg">
                        <Clock className="h-6 w-6 text-primary" />
                        <span className="font-medium text-gray-700">
                          {selectedTier?.deliveryTime || formatDeliveryTime(service.deliveryTime)}
                        </span>
                      </div>
                      <div className="flex flex-col items-center space-y-2 bg-white/50 p-4 rounded-lg">
                        ...
                        {serviceAddOns.map((addOn) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              {addOn.deliveryTime && (
                                <p className="text-sm text-gray-500 mt-1">+{addOn.deliveryTime}</p>
                              )}
                            </div>
                          </div>
                        ))}
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">{sellerProfile.completedOrders.toLocaleString()}</p>
                      </div>
                      <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="text-xs">
                                This helps us operate the platform and provide 24/7 customer support
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
